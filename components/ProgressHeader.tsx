...
export const ProgressHeader = ({ percentage, animatedStyle }: ProgressHeaderProps) => (
...
const styles = StyleSheet.create({
  ...
  badge: { backgroundColor: '#EBF8FF', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20 },
  badgeText: { color: COLORS.primary, fontWeight: '800' },
  track: { height: 12, backgroundColor: COLORS.gray[200], borderRadius: 6, overflow: 'hidden' },
